<?php
/**
 * Dashboard de TICs/Informática
 * Displays reports related to IT and computing resources
 */
...
// Filter by tipo_dashboard = 'tics'
// Get all reports filtered by TICs categories using the view
$sql = "SELECT r.*, 
...
$statsSQL = "SELECT 
    ...
    WHERE cat.tipo_dashboard = 'tics' AND r.eliminado = 0";
...
// Get chart data - monthly reports for TICs
$chartSQL = "SELECT 
...
// Get type distribution for TICs
...
$pageTitle = 'Dashboard de TICs/Informática';
...
?>
  ...
  <div class="container">
    ...
    <div class="dashboard-header">
      <h2 class="fw-bold mb-2">
        <i class="fas fa-laptop-code"></i> Dashboard de TICs/Informática
      </h2>
      <p class="mb-0">Gestión de reportes de equipo de cómputo, redes y comunicaciones</p>
    </div>
    ...
    <div class="chart-container mt-4">
      <h4 class="section-title">Listado de reportes de TICs/Informática</h4>
            ...
            <?php if (!$hasReports): ?>
              <tr>
                <td colspan="9" style="text-align: center; padding: 40px;">
                  ...
                  <p class="text-muted mt-3">No hay reportes de TICs/Informática en el sistema</p>
                </td>
              </tr>
            <?php endif; ?>
          </tbody>
  ...
  <script>
    ...
    const colors = ['#0066cc', '#00a8ff', '#3498db', '#5dade2', '#85c1e9', '#aed6f1'];
